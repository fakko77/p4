...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="admin-edit.php"><em class="far fa-newspaper">&nbsp;</em> Articles</a></li>
			<li class="active"><a href="admin-com-signaler.php"><em class="fas fa-comments">&nbsp;</em> Commentaires Signaler </a></li>
